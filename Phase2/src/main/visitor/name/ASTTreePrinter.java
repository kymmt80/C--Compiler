...
//        System.out.println(program.getStructs().size());
...
//        return type ? type hasn't "accept"
//        if(functionDec.getReturnType() != null)
...
//        return type ? type hasn't "accept"
//        if (variableDec.getVarType() != null)
...
//            setGetVarDec.getVarName().accept(this);
    ...
    public Void visit(VarDecStmt varDecStmt) {
        //todo
//        can't get line of stmt cuz we do it for vars
